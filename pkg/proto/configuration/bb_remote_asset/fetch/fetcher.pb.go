...
func (x *FetcherConfiguration) GetCaching() *FetcherConfiguration_CachingFetcherConfiguration {
	if x, ok := x.GetBackend().(*FetcherConfiguration_Caching); ok {
		return x.Caching
	}
	return nil
}
...
type FetcherConfiguration_Caching struct {
	Caching *FetcherConfiguration_CachingFetcherConfiguration `protobuf:"bytes,1,opt,name=caching,proto3,oneof"`
}
...
func (*FetcherConfiguration_Caching) isFetcherConfiguration_Backend() {}
...
type FetcherConfiguration_CachingFetcherConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Fetcher *FetcherConfiguration `protobuf:"bytes,1,opt,name=fetcher,proto3" json:"fetcher,omitempty"`
}

func (x *FetcherConfiguration_CachingFetcherConfiguration) Reset() {
	*x = FetcherConfiguration_CachingFetcherConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *FetcherConfiguration_CachingFetcherConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FetcherConfiguration_CachingFetcherConfiguration) ProtoMessage() {}

func (x *FetcherConfiguration_CachingFetcherConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FetcherConfiguration_CachingFetcherConfiguration.ProtoReflect.Descriptor instead.
func (*FetcherConfiguration_CachingFetcherConfiguration) Descriptor() ([]byte, []int) {
	return file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescGZIP(), []int{0, 0}
}

func (x *FetcherConfiguration_CachingFetcherConfiguration) GetFetcher() *FetcherConfiguration {
	if x != nil {
		return x.Fetcher
	}
	return nil
...
type FetcherConfiguration_HttpFetcherConfiguration struct {
	...
	AllowUpdatesForInstances  []string                           `protobuf:"bytes,2,rep,name=allow_updates_for_instances,json=allowUpdatesForInstances,proto3" json:"allow_updates_for_instances,omitempty"`
}
...
func (x *FetcherConfiguration_HttpFetcherConfiguration) GetContentAddressableStorage() *blobstore.BlobAccessConfiguration {
	if x != nil {
...
func (x *FetcherConfiguration_HttpFetcherConfiguration) GetAllowUpdatesForInstances() []string {
	if x != nil {
...
func (x *FetcherConfiguration_RemoteExecutionFetcherConfiguration) Reset() {
	*x = FetcherConfiguration_RemoteExecutionFetcherConfiguration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FetcherConfiguration_RemoteExecutionFetcherConfiguration) Descriptor() ([]byte, []int) {
	return file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescGZIP(), []int{0, 2}
}
...
var file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x31,
	...
	0x6f, 0x22, 0xb1, 0x07, 0x0a, 0x14, 0x46, 0x65, 0x74, 0x63, 0x68, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x7b, 0x0a, 0x07, 0x63, 0x61,
	0x63, 0x68, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x5f, 0x2e, 0x62, 0x75,
	...
	,
	...
	,
	...
	0x65, 0x74, 0x63, 0x68, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x07, 0x66, 0x65, 0x74, 0x63, 0x68, 0x65, 0x72, 0x1a, 0xd5, 0x01, 0x0a,
	0x18, 0x48, 0x74, 0x74, 0x70, 0x46, 0x65, 0x74, 0x63, 0x68, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x7a, 0x0a, 0x1b, 0x63, 0x6f, 0x6e,
	0x74, 0x65, 0x6e, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x61, 0x62, 0x6c, 0x65,
	0x5f, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a,
	0x2e, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x62, 0x61, 0x72, 0x6e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	...
	,
}
...
var file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_goTypes = []interface{}{
	...
	(*FetcherConfiguration_CachingFetcherConfiguration)(nil),         // 1: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.CachingFetcherConfiguration
	(*FetcherConfiguration_HttpFetcherConfiguration)(nil),            // 2: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.HttpFetcherConfiguration
...
var file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_depIdxs = []int32{
	1, // 0: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.caching:type_name -> buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.CachingFetcherConfiguration
	2, // 1: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.http:type_name -> buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.HttpFetcherConfiguration
	4, // 2: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.error:type_name -> google.rpc.Status
	3, // 3: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.remote_execution:type_name -> buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.RemoteExecutionFetcherConfiguration
	0, // 4: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.CachingFetcherConfiguration.fetcher:type_name -> buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration
	5, // 5: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.HttpFetcherConfiguration.content_addressable_storage:type_name -> buildbarn.configuration.blobstore.BlobAccessConfiguration
	6, // 6: buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.RemoteExecutionFetcherConfiguration.execution_client:type_name -> buildbarn.configuration.grpc.ClientConfiguration
...
func file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FetcherConfiguration_CachingFetcherConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*FetcherConfiguration_Caching)(nil),
