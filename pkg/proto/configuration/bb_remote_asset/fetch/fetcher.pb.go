...
const file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc = "" +
	"\n" +
	";pkg/proto/configuration/bb_remote_asset/fetch/fetcher.proto\x12-buildbarn.configuration.bb_remote_asset.fetch\x1a\x17google/rpc/status.proto\x1a'pkg/proto/configuration/grpc/grpc.proto\x1a'pkg/proto/configuration/http/http.proto\"\xd7\x04\n" +
	...
	"\x10remote_execution\x18\x04 \x01(\v2g.buildbarn.configuration.bb_remote_asset.fetch.FetcherConfiguration.RemoteExecutionFetcherConfigurationH\x00R\x0fremoteExecution\x1aq\n" +
	"\x18HttpFetcherConfiguration\x12I\n" +
	"\x06client\x18\x03 \x01(\v21.buildbarn.configuration.http.ClientConfigurationR\x06clientJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03\x1a\x83\x01\n" +
...
var (
	...
	file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescData []byte
)
...
func file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescGZIP() []byte {
	file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescOnce.Do(func() {
		file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc), len(file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc)))
	})
...
var file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_goTypes = []any{
...
func file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_init() {
	...
	file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc), len(file_pkg_proto_configuration_bb_remote_asset_fetch_fetcher_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
