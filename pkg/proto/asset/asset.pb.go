...
const file_pkg_proto_asset_asset_proto_rawDesc = "" +
	"\n" +
	"\x1bpkg/proto/asset/asset.proto\x12\x0fbuildbarn.asset\x1a.build/bazel/remote/asset/v1/remote_asset.proto\x1a6build/bazel/remote/execution/v2/remote_execution.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"l\n" +
...
var (
	...
	file_pkg_proto_asset_asset_proto_rawDescData []byte
)

func file_pkg_proto_asset_asset_proto_rawDescGZIP() []byte {
	file_pkg_proto_asset_asset_proto_rawDescOnce.Do(func() {
		file_pkg_proto_asset_asset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_proto_asset_asset_proto_rawDesc), len(file_pkg_proto_asset_asset_proto_rawDesc)))
	})
...
var file_pkg_proto_asset_asset_proto_goTypes = []any{
...
func file_pkg_proto_asset_asset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_proto_asset_asset_proto_rawDesc), len(file_pkg_proto_asset_asset_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
