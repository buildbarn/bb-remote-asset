...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:n6FE+EjZZvkj6t0aodiU46/V41dVHuuk7RXJKLTrxgU=",
        version = "v0.0.0-20230524183638-cf282e574e60",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xJhySr0Nw/DJ3jIQl1hgQ2GWuBiKcW3VyeYhV3wDWIk=",
        version = "v0.0.0-20230613102712-e89168d76a46",
    )
    go_repository(
