...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:kqzEfGGDIrRJpfJckgwuZfFTbU9NB1jZnRcaO9MpOqE=",
        version = "v1.23.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:hwZB07/beLiCopuRKF0t+dEHmP39iN4YtDh3X5d3hrg=",
        version = "v1.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:s06EMWkOg/nuYQecczyImc8cQ0lXf1oAGNHnwqTqsYE=",
        version = "v0.0.0-20231004102325-0bcfdc0d99ac",
    )
    go_repository(
